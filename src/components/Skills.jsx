...
export default function Skills() {
  ...
  return (
    <section className="relative w-full px-4 sm:px-6 md:px-10 lg:px-20 py-10 bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
      <motion.div
      ...
      >
        <div className="flex items-center justify-center space-x-8 sm:space-x-16 md:space-x-32">
          <span className="text-[15rem] sm:text-[20rem] md:text-[25rem] font-bold text-transparent bg-gradient-to-r from-yellow-300 to-yellow-500 bg-clip-text dark:hidden">
            {"{"}
          </span>
          <span className="text-[15rem] sm:text-[20rem] md:text-[25rem] font-bold text-transparent bg-gradient-to-r from-yellow-300 to-yellow-500 bg-clip-text dark:hidden">
            {"}"}
          </span>
          <span className="text-[15rem] sm:text-[20rem] md:text-[25rem] font-bold text-transparent bg-gradient-to-r from-yellow-600 to-yellow-400 bg-clip-text hidden dark:block">
            {"{"}
          </span>
          <span className="text-[15rem] sm:text-[20rem] md:text-[25rem] font-bold text-transparent bg-gradient-to-r from-yellow-600 to-yellow-400 bg-clip-text hidden dark:block">
            {"}"}
      ...
      <motion.h2
        ...
        className="text-3xl sm:text-4xl font-bold mb-10 text-center z-10 bg-gradient-to-r from-yellow-500 via-orange-500 to-yellow-400 text-transparent bg-clip-text"
      >
        Skills
      </motion.h2>
